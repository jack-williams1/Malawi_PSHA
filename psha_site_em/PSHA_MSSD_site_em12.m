...
% Synthetic earthquake catalog is generated from syncat_MSSD.m
% Epistemic uncertainity assessed through ensemble modelling
% Site specific PSHA, returns ground motions only
% See PSHA_MSSD_site_figures to assess ground motions
...
num_par=12; %script number in fake parallelisation
...
load('syncat_PSHA_MSSD_input','num_GMPEindex','GMPEindex','weight_GMPEindex','Z10_Z25','vs30_site_ref',...
...
%% Selection and creation of combined catalog from Direct and Adapted MSSD 
