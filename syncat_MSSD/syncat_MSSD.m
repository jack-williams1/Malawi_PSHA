...
%For direct interpretation of the MSSD%
...
load ('syncat_PSHA_MSSD_input','t_limit','NumSimu','syncat_name','weight_SWM','num_TD','weight_TD','para_Mw')
...
%recurrence_para1: int RI for MSSD faults
%recurrence_para2: int RI for MSSD sections and MSSD faults if faults unsegmented
%recurrence_para3: int RI for MSSD sections and MSSD multifaults and faults if unsegmented
%recurrence_para4: int RI for MSSD multifauts and MSSD faults if faults isolated
%recurrence_para5: int RI for MSSD multifaults and MSSD sections if faults segmented and isolated
