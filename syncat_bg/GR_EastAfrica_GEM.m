...
mag_check = Mmin:0.1:Mmax; TotalYear=2015-YearStart;
...
%Save variable so that it can be plotted in all Malawi MFD plot (see mssd_comb.m)
save('GR_TintiMulargia','Stat_log10N','EAcatalog_R1','mag_check','AnnualCumNum','TotalYear');
