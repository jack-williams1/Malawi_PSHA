%% Plot figure of MSSD sources stored in fault_geom
...
%Name of faults in the MAFD but not in the MSSD (see Table S2 in MSSD manuscript)
...
for kk = 1:num_traces 
    ...
    if contains(MAFD(kk).fault_name,removed_faults)==1
        %map faults not included in the MSSD as black
