...
load('syncat_PSHA_MSSM_input','num_GMPEindex','GMPEindex','weight_GMPEindex','FMtype','FMweight','Z10_Z25','vs30_site_ref',...
...
for i=1:length(StochasticEventCatalog)
    ...
    %UNCOMMENT FOR TESTING, REMOVE WHEN ON BLUE CRYSTAL
